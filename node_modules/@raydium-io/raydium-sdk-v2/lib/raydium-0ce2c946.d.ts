...
import { CreateLaunchPad, LaunchpadPoolInfo, BuyToken, BuyTokenExactOut, SellToken, SellTokenExactOut, CreatePlatform, UpdatePlatform, ClaimPlatformFee, ClaimAllPlatformFee, CreateVesting, CreateMultipleVesting, ClaimVesting, ClaimMultiVesting, ClaimVaultPlatformFee, ClaimMultipleVaultPlatformFee, ClaimCreatorFee, LaunchpadConfigInfo } from './raydium/launchpad/type.js';
...
declare class LaunchpadModule extends ModuleBase {
    constructor(params: ModuleBaseProps);
    createLaunchpad<T extends TxVersion>({ programId, authProgramId, platformId, mintA, decimals, mintBDecimals, name, symbol, uri, migrateType, configId, configInfo: propConfigInfo, platformFeeRate, txVersion, computeBudgetConfig, txTipConfig, feePayer, buyAmount, minMintAAmount, slippage, associatedOnly, checkCreateATAOwner, extraSigners, token2022, transferFeeExtensionParams, ...extraConfigs }: CreateLaunchPad<T>): Promise<MakeMultiTxData<T, {
        address: LaunchpadPoolInfo & {
            poolId: PublicKey;
        };
        swapInfo: SwapInfoReturnExt;
    }>>;
    buyToken<T extends TxVersion>({ programId, authProgramId, mintA, mintAProgram, mintB, poolInfo: propPoolInfo, configInfo: propConfigInfo, platformFeeRate, txVersion, computeBudgetConfig, txTipConfig, feePayer, buyAmount, minMintAAmount: propMinMintAAmount, slippage, shareFeeRate, shareFeeReceiver, associatedOnly, checkCreateATAOwner, transferFeeConfigA: propsTransferFeeConfigA, skipCheckMintA, }: BuyToken<T>): Promise<MakeTxData<T, SwapInfoReturnExt>>;
